...
(set M.base_30.statusline_bg M.base_30.black2)
(set M.base_30.lightbg M.base_30.one_bg2)
(set M.base_30.pmenu_bg M.base_30.blue)
(set M.base_30.folder_bg M.base_30.blue)

(set M.base_16 {:base00 M.base_30.black
...
(set M.polish_hl
     {:treesitter {"@variable.member.key" {:fg M.base_16.base05}
...
((. (require :base46) :override_theme) M :abyssal)
